  ...
  return (
    <div className="bg-slate-50">
      <div className="mx-auto max-w-6xl px-6 pt-8 sm:px-10">
        <Link
          href="/"
          className="inline-flex items-center gap-1.5 text-sm font-medium text-slate-500 transition-colors hover:text-navy-950"
        >
      ...
      */}
      <ScrollSpyNav
        ...
        navClassName="sticky top-16 z-10 mt-16 flex gap-2 overflow-x-auto border-y border-transparent bg-slate-50 px-6 py-3 [-ms-overflow-style:none] [scrollbar-width:none] [border-image:linear-gradient(to_right,transparent,var(--color-slate-300),transparent)_1] [&::-webkit-scrollbar]:hidden sm:px-10 sm:flex-wrap sm:justify-center sm:overflow-visible"
      ...
      <div className="mx-auto max-w-6xl px-6 pb-20 sm:px-10">
        <div className="flex flex-col gap-16 pt-16">
          ...
          <div className="relative mx-auto w-full max-w-2xl overflow-hidden rounded-[14px] bg-[radial-gradient(ellipse_110%_160%_at_0%_35%,var(--color-navy-800)_15%,var(--color-navy-950)_65%,#03060f_100%)] px-8 py-9">
            <div
              aria-hidden="true"
